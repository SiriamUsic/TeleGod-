...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./TeleGod
done
]])
Run:close()
...
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TeleGod,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(TeleGod.."DevelopersQ:Groups",UserId) 
HELPBEVQ = Redis:sismember(TeleGod.."HELPBEVQ:Groups",UserId) 
Developers = Redis:sismember(TeleGod.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(TeleGod.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(TeleGod.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(TeleGod.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TeleGod.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TeleGod.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TeleGod.."Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if tonumber(UserId) == 5372193406 then
Status = 'مبرمج السورس'
...
JoinChannel = true
local Channel = Redis:get(TeleGod..'Channel:Join')
if Channel then
...
Redis:sadd(TeleGod.."allM"..msg.chat_id, msg.id)
if Redis:get(TeleGod.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(TeleGod.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(TeleGod.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(TeleGod.."allM"..msg.chat_id)
...
Redis:del(TeleGod.."allM"..msg.chat_id)
end
end
end
...
elseif Redis:sismember(TeleGod.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TeleGod.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(TeleGod.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TeleGod.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TeleGod.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TeleGod.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TeleGod.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TeleGod.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TeleGod.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TeleGod.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TeleGod.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TeleGod.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TeleGod.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TeleGod.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TeleGod.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
...
if Redis:get(TeleGod.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TeleGod.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TeleGod) then
return false
end
...
if text and Redis:get(TeleGod..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(TeleGod..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(TeleGod..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
Redis:set(TeleGod.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TeleGod.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TeleGod..'Channel:Join')}, },}}
...
Redis:sadd(TeleGod.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TeleGod.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TeleGod.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TeleGod.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TeleGod.."Distinguished:Group"..GroupId,v)
end
end 
end
...
if text == 'رفع نسخه تلي جود' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
Redis:sadd(TeleGod.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TeleGod.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TeleGod.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TeleGod.."TheBasics:Group"..idg,idASAS)
end;end
end
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ تم استرجاع المجموعات من نسخه تلي جود')
else
...
os.execute('rm -rf TeleGod.lua')
os.execute('wget https://adfrv.zzz.com.ua/beb/TeleGod.lua')
...
local President = Redis:smembers(TeleGod.."TheBasics:Group"..v)
local Constructor = Redis:smembers(TeleGod.."Originators:Group"..v)
local Manager = Redis:smembers(TeleGod.."Managers:Group"..v)
local Admin = Redis:smembers(TeleGod.."Addictive:Group"..v)
local Vips = Redis:smembers(TeleGod.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(TeleGod..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⋆' then 
Redis:del(TeleGod..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,TeleGod).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⋆ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TeleGod..'Channel:Join',ChannelUser) 
...
Redis:set(TeleGod..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:del(TeleGod..'Channel:Join')
...
return LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TeleGod..'Num:Add:Bot'),"md",true)  
end
...
Redis:set(TeleGod.."Status:Id"..msg_chat_id,true) ;Redis:set(TeleGod.."Status:Reply"..msg_chat_id,true) ;Redis:set(TeleGod.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TeleGod.."Status:BanId"..msg_chat_id,true) ;Redis:set(TeleGod.."Status:SetId"..msg_chat_id,true) 
...
Redis:set(TeleGod.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(TeleGod.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TeleGod.."allM"..msg.chat_id)  
...
Redis:del(TeleGod.."Status:Del:Media"..msg.chat_id)
...
Redis:set(TeleGod.."Status:Del:Media"..msg.chat_id,true)
...
if not Redis:sismember(TeleGod.."DevelopersQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."DevelopersQ:Groups",bana.id) 
...
if not Redis:sismember(TeleGod.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(TeleGod.."HELPBEVQ:Groups")
Redis:del(TeleGod.."HELPBEVQ:Groups", bana.id)
Redis:del(TeleGod.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(TeleGod.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Developers:Groups",bana.id) 
...
if not Redis:sismember(TeleGod.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TeleGod.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TeleGod.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TeleGod.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TeleGod.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TeleGod.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TeleGod.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TeleGod.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(TeleGod.."HELPBEVQ:Groups")
Redis:del(TeleGod.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(TeleGod.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(TeleGod.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TeleGod.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TeleGod.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TeleGod.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TeleGod.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TeleGod.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦ يارب تعقل ⋆   🙃 ").Reply,"md",true)  
else
Redis:srem(TeleGod.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TeleGod.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦ اعقل وبلاش خزوقه ⋆   🙃 ").Reply,"md",true)  
else
Redis:srem(TeleGod.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TeleGod.."DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TeleGod.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(TeleGod.."HELPBEVQ:Groups")
Redis:del(TeleGod.."HELPBEVQ:Groups", UserId)
Redis:del(TeleGod.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(TeleGod.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Developers:Groups",UserId) 
...
if not Redis:sismember(TeleGod.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TeleGod.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TeleGod.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TeleGod.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TeleGod.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TeleGod.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TeleGod.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(TeleGod.."HELPBEVQ:Groups")
Redis:sadd(TeleGod.."HELPBEVQ:Groups", UserId)
Redis:set(TeleGod.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(TeleGod.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Developers:Groups",bana.id) 
...
if Redis:sismember(TeleGod.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TeleGod.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TeleGod.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TeleGod.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Managers:Group"..msg_chat_id,bana.id) 
...
if not msg.Originators and not Redis:get(TeleGod.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TeleGod.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TeleGod.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TeleGod.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TeleGod.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(TeleGod.."HELPBEVQ:Groups")
Redis:sadd(TeleGod.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(TeleGod.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(TeleGod.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TeleGod.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦ هي كد كده محطوط بنتك  ⋆ ⋆ ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."bwoman:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦ هو كده كده محطوط ابنك  ⋆ ⋆ ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."botaua:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TeleGod.."alpe:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TeleGod.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(TeleGod.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⋆ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Developers:Groups",UserId) 
...
if Redis:sismember(TeleGod.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TeleGod.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TeleGod.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TeleGod.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TeleGod.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TeleGod.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⋆ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
local Info_Members = Redis:smembers(TeleGod.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TeleGod.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*⋆ قائمه مطورين البوت \n ⩹━◜𝑠𝑜𝑢𝑟𝑐𝑒 𝑡𝑒𝑙𝑒𝑔𝑜𝑑◞━⩺*\n'
...
local Info_Members = Redis:smembers(TeleGod.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TeleGod.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TeleGod.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TeleGod.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TeleGod.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TeleGod.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TeleGod.."alpe:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TeleGod.."botaua:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TeleGod.."bwoman:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
if TextMsg == 'صورتي' then
Redis:del(TeleGod.."Status:photo"..msg_chat_id) 
...
if TextMsg == 'قول' then
Redis:del(TeleGod.."Status:kool"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تعطيل امر قول ","md",true)
end
if TextMsg == 'جمالي' then
Redis:del(TeleGod.."Status:gamle"..msg_chat_id) 
...
if not msg.Originators and not Redis:get(TeleGod.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TeleGod.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'banned',0)
...
if not Redis:sismember(TeleGod.."BanGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(TeleGod.."BanGroup:Group"..msg_chat_id,bana.id) 
LuaTele.setChatMemberStatus(msg.chat_id,bana.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TeleGod.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(TeleGod.."SilentGroup:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TeleGod.."SilentGroup:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(TeleGod.."SilentGroup:Group"..msg_chat_id,bana.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⋆ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
Rink = 1
elseif Redis:sismember(TeleGod.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TeleGod.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(TeleGod.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(TeleGod.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(TeleGod.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(TeleGod.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(TeleGod.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(TeleGod.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(TeleGod.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(TeleGod.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(TeleGod.."Status:KickMe"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"*مفيش طرد اترزع هنا وانت ساكت *","md",true)  
end
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*⋆ عذرآ البوت ليس ادمن في الجروب يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TeleGod.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TeleGod.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local TestText = "  ❲ Developers TeleGod  ❳\n— — — — — — — — —\n ⋆*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n⋆ *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
if photo.total_count > 0 then
local TestText = "  ❲ «◜𝑠𝑜𝑢𝑟𝑐𝑒 𝑡𝑒𝑙𝑒𝑔𝑜𝑑◞» ❳\n— — — — — — — — —\n ⋆*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n⋆ *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '< Developers TeleGod  >', url = "https://t.me/BK_ZT"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'مبرمج السورس' or text == 'تلي جود' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n*•  تلي جود معندوش حساب في البنك 🫢*","md",true)  
return false
end
...
send(msg.chat_id,msg.id, "حوالة صادرة من بنك تلي جود\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمستلم : "..newss.."\nالحساب رقم : `"..text.."`\nنوع البطاقة : "..fsvhh.."\nخصمت 10% رسوم تحويل\nالمبلغ : "..UserNameyy.." جنيه 💵","md",true)
send(fsvhhh,0, "حوالة واردة من بنك تلي جود\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمبلغ : "..UserNameyy.." جنيه 💵","md",true)
Redis:del(black.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(black.."transn" .. msg.sender.user_id)
else
send(msg.chat_id,msg.id, "•  مافيه حساب بنكي كذا","md",true)
...
local Added_Me = Redis:get(TeleGod.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
Redis:sadd(TeleGod.."cleaner"..msg_chat_id,msg_id)
end
if text == "مسح الميديا" then 
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⋆ هاذا الامر يخص⦗ '..Controller_Num(6)..' ⦘* ',"md",true)  
end
local list = Redis:smembers(TeleGod.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(TeleGod.."cleaner"..msg_chat_id)
...
if Redis:get(TeleGod.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TeleGod.."Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(TeleGod.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
Redis:set(TeleGod..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⋆ تم قفـل السب").Lock,"md",true)  
end
...
Redis:del(TeleGod..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⋆ تم فتح السب").unLock,"md",true)  
end
...
if Redis:get(TeleGod.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❎ ❭'
end
if Redis:get(TeleGod.."Status:ReplySudo"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(TeleGod.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TeleGod.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(TeleGod.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TeleGod.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TeleGod.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TeleGod.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(TeleGod.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(TeleGod.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(TeleGod.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(TeleGod.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(TeleGod.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(TeleGod.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(TeleGod.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(TeleGod.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(TeleGod.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(TeleGod.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد رسائلك هنا *~ '..(Redis:get(TeleGod..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد التعديلات هنا *~ '..(Redis:get(TeleGod..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⋆ عدد جهاتك المضافه هنا *~ '..(Redis:get(TeleGod.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:del(TeleGod.."DevelopersQ:Groups") 
...
Redis:del(TeleGod.."Developers:Groups") 
...
Redis:del(TeleGod.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(TeleGod.."Originators:Group"..msg_chat_id) 
...
Redis:del(TeleGod.."Managers:Group"..msg_chat_id) 
...
Redis:del(TeleGod.."Addictive:Group"..msg_chat_id) 
...
Redis:del(TeleGod.."Distinguished:Group"..msg_chat_id) 
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '◜𝑠𝑜𝑢𝑟𝑐𝑒 𝑡𝑒𝑙𝑒𝑔𝑜𝑑◞',url="https://t.me/sr_TeleGod"}}
}
local msg_id = msg.id/2097152/0.5
...
local Name = '* ╭───── •⋆• ─────╮\n*⋆ [𝑺𝑶𝑼𝑹𝑪𝑬](t.me/sr_TeleGod)*\n*⋆ [𝑰𝑵𝑭𝑶 𝑺𝑶𝑼𝑹𝑪𝑬](t.me/sr_TeleGod)*\n*⋆ [𝑮𝑹𝑶𝑼𝑷 𝑻𝑾𝑺](t.me/bajwkk)*\n*⋆ [𝑫𝑬𝑽 𝑺𝑶𝑼𝑹𝑪𝑬 𝑬𝑳𝑵𝑮𝑶𝑶𝑴](t.me/BK_ZT)*\n╰───── • ⋆ • ─────╯\n⍟ 𝑻𝑯𝑬 𝑩𝑬𝑺𝑻 𝑶𝑵 𝑺𝑶𝑼𝑹𝑪𝑬 ⏎*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'اضف البوت الي مجموعتك✅', url = 't.me/'..UserBot..'?startgroup=new'}
...
local ban = LuaTele.getUser(TeleGod)
local Namebot = (Redis:get(TeleGod.."Name:Bot") or "تلي جود")
local BotName = {
...
Redis:incrby(TeleGod.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TeleGod.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:set(TeleGod.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TeleGod.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TeleGod.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TeleGod.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(TeleGod.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TeleGod.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TeleGod.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TeleGod.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TeleGod.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TeleGod.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local CmdStart = '*\n🍷ــــــــــــــــــــــــــــــــــــــــــــــــــــــ🍷\n🎤╖ اهلا بك عزيزي انا بوت '..(Redis:get(TeleGod.."Name:Bot") or "تلي جود")..
'\n⚙️╢ وظيفتي حماية المجموعات'..
'\n✅╢ لتفعيل البوت عليك اتباع مايلي ...'..
'\n🔘╢ أضِف البوت إلى مجموعتك'..
'\n⚡️╢ ارفعهُ » مشرف'..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TeleGod.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
Redis:set(TeleGod.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(TeleGod.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."AddSudosNew"..ChatId)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '| رجـــوع |', data =UserId..'/'.. 'NoNextSeting'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '| رجـــوع |', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."rb:bna"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '| رجـــوع |', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⋆ تم تعطيل امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TeleGod.."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '| رجـــوع |', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TeleGod.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TeleGod.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(TeleGod.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TeleGod..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "⋆ تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
{
{text = '| رجـــوع |', data =IdUser..'/'.. 'NoNextSeting'}
},
{
{text = '{ᴍᴀɪɴ ᴍᴇɴụ}', data = IdUser..'/helpall'},
},
...
{
{text = '| رجـــوع |', data =UserId..'/'.. 'NoNextSeting'},
},
}
}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '| رجـــوع |', data =UserId..'/'.. 'NoNextSeting'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '◜𝑠𝑜𝑢𝑟𝑐𝑒 𝑡𝑒𝑙𝑒𝑔𝑜𝑑◞', url = 't.me/sr_TeleGod'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."alpe:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '◜𝑠𝑜𝑢𝑟𝑐𝑒 𝑡𝑒𝑙𝑒𝑔𝑜𝑑◞', url = 't.me/sr_TeleGod'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."bwoman:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '◜𝑠𝑜𝑢𝑟𝑐𝑒 𝑡𝑒𝑙𝑒𝑔𝑜𝑑◞', url = 't.me/sr_TeleGod'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TeleGod.."botaua:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '◜𝑠𝑜𝑢𝑟𝑐𝑒 𝑡𝑒𝑙𝑒𝑔𝑜𝑑◞', url = 't.me/sr_TeleGod'},},}}
